...
type DiaryEntry struct {
	...
	PublishedAt *google_protobuf.Timestamp `protobuf:"bytes,6,opt,name=published_at,json=publishedAt" json:"published_at,omitempty"`
}
...
func (m *DiaryEntry) GetAuthor() *User {
	if m != nil {
		return m.Author
	}
	return nil
...
type DiaryEntryForm struct {
	...
	ImageUrls []string `protobuf:"bytes,3,rep,name=image_urls,json=imageUrls" json:"image_urls,omitempty"`
}
...
func (m *DiaryEntryForm) GetImageUrls() []string {
	if m != nil {
		return m.ImageUrls
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
